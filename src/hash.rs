    ...
    for loop_iterator1 in (0..data.len()).step_by(16) {
        for loop_iterator2 in 0..80 {
            if loop_iterator2 <= 15 {
                ...
                w_array[loop_iterator2] = sigma1(w_array[loop_iterator2 - 2])
                    .wrapping_add(w_array[loop_iterator2 - 7])
                    .wrapping_add(sigma0(w_array[loop_iterator2 - 15]))
                    .wrapping_add(w_array[loop_iterator2 - 16]);
            }
        }
